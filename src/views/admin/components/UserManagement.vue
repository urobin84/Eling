...
function deleteSelected() {
    if (confirm(`Are you sure you want to delete ${selectedIds.value.length} users?`)) {
        // In real app, emit bulk delete or invoke delete command
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div class="relative w-full sm:w-96">
                <input v-model="searchQuery" type="text" placeholder="Search users by name, role, or ID..."
        ...
        <div class="glass-panel overflow-hidden border-black/5 dark:border-white/5 relative">
            ...
            <div
                ...
                <!-- Same pagination as CandidateList -->
        ...
        <div v-if="showCreateModal" class="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <div
                ...
                <h3 class="text-lg font-bold text-gray-900 dark:text-eling-dark-text mb-1">New User</h3>
                <p class="text-xs text-gray-900 dark:text-eling-dark-text/50 mb-6">Create a new system user.
                </p>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                     ...
                     <div>
                        <label
                            class="block text-xs font-mono text-gray-900 dark:text-eling-dark-text/70 mb-1 uppercase">Role
                            (Required)</label>
                        <BaseSelect
                ...
                <div class="mt-8 flex justify-end space-x-3">
                    ...
                    <button @click="handleCreateUser" class="btn-neumorphic px-6 py-2 text-sm font-bold">Create
                        User</button>
                </div>
            </div>
        </div>

        <!-- Loading & Success Modals (Same as CandidateList) -->
        <div v-if="isLoading"
        ...
        <div v-if="showSuccessModal" class="fixed inset-0 z-[60] flex items-center justify-center px-4">
            ...
            <div
                ...
                <p class="text-gray-900 dark:text-eling-dark-text/70 text-sm">User created successfully.</p>
            </div>
        </div>
    </div>
</template>
